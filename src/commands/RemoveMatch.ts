...
export default class RemoveDivision extends Command{
    ...
    async execute(interaction: ChatInputCommandInteraction){
        try{
            ...
            if(!match){
                await interaction.reply(`Das angegebene Match in der division  ${interaction.options.getString("division-name")!} existiert entweder nicht oder ist bereits confirmed und kann nicht mehr gelöscht werden.`)
                return
            }
